  ...
  <!-- Contenedor de todo el footer -->
    ...
    <!-- Contenedor de la parte AYUDA del footer -->
          <ul class="footer_ul">
            ...
            <li><a href="secciones/faq.php">Preguntas frecuentes</a></li>
            <li><a href="secciones/proximamente.php">Promociones y descuentos</li><br>
            <li><a href="secciones/proximamente.php">Medios de pago</li>
    ...
    <!-- Contenedor de la parte MI CUENTA del footer -->
      ...
      <!-- Lista de elementos de la parte MI CUENTA del footer -->
            ...
            <li><a href="secciones/proximamente.php">Estado de mi pedido</a></li>
            <li><a href="secciones/login.php">Login</a></li>
            <li><a href="secciones/registro.php">Registrarse</a></li>
            <li><a href="#">Recuperar contraseña</a></li>
            <li><a href="secciones/perfil.php">Mi perfil</a></li>
      </ul>
    </div>
    ...
    <!-- Contenedor de la parte VISITANOS del footer -->
      ...
      <!-- Lista de elementos de la parte VISITANOS del footer -->
            ...
            <li>
              <form class="footer_newsletter" action="index.php" method="post">
    ...
    <!-- Contenedor de la parte DIRECCIONES del footer -->
          ...
          <!-- Lista de elementos de la parte DIRECCIONES del footer -->
            <li class="footer_marca"><a href="index.php"><img src="img/logo.png" alt="imagen del logo"></a></li>
